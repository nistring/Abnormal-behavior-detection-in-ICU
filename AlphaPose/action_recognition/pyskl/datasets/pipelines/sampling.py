...
class SampleFrames:
    ...
    def _get_test_clips(self, num_frames):
        ...
        clip_offsets = np.arange(0, self.num_clips, self.clip_len//3, dtype=np.int)
        self.num_clips = clip_offsets.shape[0]
    ...
    def _sample_clips(self, num_frames, test_mode=False):
        ...
        if test_mode:
            ...
            start = randint(0, num_frames - self.clip_len) if num_frames > self.clip_len else 0
            clip_offsets = np.array([start])
